...
public class PersonalTraining extends ExercisePlan {

	public PersonalTraining(int planId, int classesId, Trainer trainerId, Equipment equipmentId, LocalDate day,
