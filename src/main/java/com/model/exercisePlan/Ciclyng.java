...
public class Ciclyng extends ExercisePlan {

	public Ciclyng(int planId, int classesId, Trainer trainerId, Equipment equipmentId, LocalDate day, LocalTime startClass,
			LocalTime time, int maxNoOfParticipants) {
